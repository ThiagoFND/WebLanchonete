...
function exibirDados(dados) {
    ...
    if (dados.length === 0) {
        ...
        const headers = ["Selecionar", "Dinheiro", "Pix", "Cartao", "Data"];
...
async function deletarCodigo(contatoId, token) {
    const url = `http://localhost:8080/api/v1/dados/vendas/delete/${contatoId}`; // Alterei de usuarioId para contatoId
